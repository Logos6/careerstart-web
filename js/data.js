...
var SKILL_GROUPS = [
  {
    group: "办公与通用",
    items: [
      { id: "office",     label: "Office 办公套件" },
      { id: "wps",        label: "WPS 办公" },
      { id: "typing",     label: "打字录入" },
      { id: "file",       label: "档案管理" },
      { id: "meeting",    label: "会议组织" },
      { id: "reception",  label: "接待礼仪" },
      { id: "scheduling", label: "日程安排" },
      { id: "correspond", label: "公文写作" },
      { id: "stamp",      label: "印章管理" },
      { id: "asset",      label: "资产管理" },
  ...
  },
  {
    group: "设计与创意",
    items: [
      { id: "uidesign",   label: "UI/UX 设计" },
      { id: "graphic",    label: "平面设计" },
      { id: "logo",       label: "Logo 设计" },
      { id: "poster",     label: "海报设计" },
      { id: "packaging",  label: "包装设计" },
      { id: "interior",   label: "室内设计" },
      { id: "cad",        label: "CAD 制图" },
      { id: "3d",         label: "3D 建模" },
      { id: "animation",  label: "动画制作" },
      { id: "video",      label: "视频剪辑" },
      { id: "photo",      label: "摄影" },
      { id: "retouch",    label: "修图 / 后期" },
      { id: "handwrite",  label: "手绘 / 插画" },
      { id: "typeset",    label: "排版设计" },
    ],
  },
  {
    group: "写作与内容",
    items: [
      ...
      { id: "copywriting",label: "广告文案" },
      { id: "seo",        label: "SEO 优化" },
      { id: "article",    label: "文章撰写" },
      { id: "script",     label: "脚本创作" },
      { id: "translate",  label: "翻译" },
      { id: "edit",       label: "编辑校对" },
      { id: "proofread",  label: "文案审核" },
      { id: "brand",      label: "品牌策划" },
      { id: "pr",         label: "公关传播" },
    ],
  },
  ...
  },
  {
    group: "演讲与沟通",
    items: [
      { id: "speaking",   label: "演讲 / 表达" },
      { id: "train",      label: "授课 / 培训" },
      { id: "negotiate",  label: "商务谈判" },
      { id: "host",       label: "主持 / MC" },
      { id: "persuade",   label: "说服 / 劝导" },
      { id: "listen",     label: "倾听 / 共情" },
      { id: "mediation",  label: "调解 / 冲突处理" },
    ],
  },
  {
    group: "销售与市场",
    items: [
      { id: "sales",      label: "销售 / 谈判" },
      { id: "b2b",        label: "大客户销售" },
      { id: "b2c",        label: "门店销售" },
      { id: "telemark",   label: "电话销售" },
      { id: "online",     label: "线上销售" },
      { id: "channel",    label: "渠道拓展" },
      { id: "market",     label: "市场推广" },
      { id: "promote",    label: "活动推广" },
      { id: "fission",    label: "裂变增长" },
      { id: "operate",    label: "用户运营" },
      { id: "data2",      label: "数据运营" },
      { id: "content2",   label: "内容运营" },
      { id: "community2", label: "社群运营" },
      { id: "live2",      label: "直播运营" },
    ],
  },
  {
    ...
    items: [
      ...
      { id: "lead",       label: "领导力" },
      { id: "plan",       label: "规划能力" },
      { id: "delegate",   label: "任务分配" },
      { id: "review",     label: "绩效考核" },
      { id: "mentor",     label: "导师 / 带教" },
      { id: "change",     label: "变革管理" },
      { id: "risk",       label: "风险管理" },
      { id: "budget",     label: "预算管理" },
    ],
  },
  {
    group: "财务与法务",
    items: [
      { id: "accounting", label: "会计核算" },
      { id: "tax",        label: "税务申报" },
      { id: "audit2",     label: "审计" },
  ...
  },
  {
    ...
    items: [
      { id: "recruit",    label: "招聘" },
      { id: "interview",  label: "面试技巧" },
      { id: "onboard",    label: "入职管理" },
      { id: "train2",     label: "培训组织" },
      { id: "payroll",    label: "薪酬管理" },
      { id: "social2",    label: "社保公积金" },
      { id: "employee",   label: "员工关系" },
      { id: "hrsystem",   label: "HR 系统操作" },
      { id: "doc2",       label: "文档撰写" },
      { id: "secretary",  label: "秘书实务" },
    ],
  },
  {
    group: "运营与电商",
    items: [
      { id: "shop",       label: "店铺运营" },
      { id: "product",    label: "选品 / 采购" },
      { id: "price",      label: "定价策略" },
      { id: "ads",        label: "广告投放" },
      { id: "seo2",       label: "搜索优化" },
      { id: "crm",        label: "CRM 管理" },
      { id: "aftermarket",label: "售后服务" },
      { id: "logistics2", label: "物流调度" },
      { id: "quality2",   label: "品质管控" },
      { id: "complain",   label: "客诉处理" },
    ],
  },
  {
    group: "教育与培训",
    items: [
      { id: "teach",      label: "教学讲解" },
      { id: "lesson",     label: "课程设计" },
      { id: "classroom",  label: "课堂管理" },
      { id: "student",    label: "学生管理" },
      { id: "exam",       label: "考试命题" },
      { id: "tutor2",     label: "一对一辅导" },
      { id: "online2",    label: "在线教育" },
      { id: "courseware",  label: "课件制作" },
    ],
  },
  {
    group: "客服与服务",
    items: [
      { id: "hotline",    label: "热线接听" },
      { id: "complaint",  label: "投诉处理" },
      { id: "vip",        label: "VIP 服务" },
      { id: "survey",     label: "满意度调查" },
      { id: "after",      label: "售后支持" },
      { id: "visit",      label: "回访跟进" },
      { id: "counsel",    label: "咨询顾问" },
    ],
  },
  {
    group: "医疗与健康",
    items: [
      { id: "nurse",      label: "护理" },
      { id: "pharm",      label: "药剂" },
      { id: "diagnose",   label: "诊断辅助" },
      { id: "rehab",      label: "康复训练" },
      { id: "nutrition",  label: "营养指导" },
      { id: "acupuncture",label: "针灸推拿" },
      { id: "elder2",     label: "老年护理" },
      { id: "child2",     label: "母婴护理" },
      { id: "psych2",     label: "心理疏导" },
      { id: "firstaid",   label: "急救知识" },
    ],
  },
  {
    group: "制造与技术",
    items: [
      ...
      { id: "repair",     label: "维修" },
      { id: "weld",       label: "焊接" },
      { id: "electric",   label: "电工" },
      { id: "plumb",      label: "管道" },
      { id: "machine",    label: "机械操作" },
      { id: "assemble",   label: "装配" },
      { id: "inspect",    label: "质量检验" },
      { id: "blueprint",  label: "图纸识别" },
      { id: "safety",     label: "安全规范" },
      { id: "warehouse",  label: "仓储管理" },
      { id: "forklift",   label: "叉车操作" },
    ],
  },
  {
    group: "生活服务",
    items: [
      ...
      { id: "moving",     label: "搬家" },
      { id: "lock",       label: "开锁" },
      { id: "appliance",  label: "家电维修" },
      { id: "sewing",     label: "缝纫 / 改衣" },
    ],
  },
  {
    group: "农业与畜牧",
    items: [
      ...
      { id: "agriproduct",label: "农产品加工" },
      { id: "agritech",   label: "农业技术" },
    ],
  },
];
...
/* ---------- 技能课程库（覆盖全部招聘大类） ---------- */
var COURSES = [
  { id: "c-excel", cat: "职能", icon: "i-chart", title: "Excel 从零到精通", sub: "王佩丰 · 24节全集", lessons: 24, hours: 24, xp: 30, bg: "linear-gradient(150deg,#1d8fa8,#106d81)", skills: ["office", "datatool"], url: "https://search.bilibili.com/all?keyword=Excel%E4%BB%8E%E9%9B%B6%E5%88%B0%E7%B2%BE%E9%80%9A%20%E7%8E%8B%E4%BD%A9%E4%B8%B0" },
  { id: "c-excel2", cat: "职能", icon: "i-chart", title: "Excel VBA 入门到实战", sub: "自动化办公 · 效率提升10倍", lessons: 30, hours: 15, xp: 28, bg: "linear-gradient(150deg,#2a6f97,#1a4b6d)", skills: ["office", "datatool"], url: "https://search.bilibili.com/all?keyword=Excel%20VBA%20%E5%85%A5%E9%97%A8%E5%88%B0%E5%AE%9E%E6%88%98" },
  { id: "c-word", cat: "职能", icon: "i-doc", title: "Word 文档排版速成", sub: "公文 / 合同 / 长文档", lessons: 15, hours: 6, xp: 15, bg: "linear-gradient(150deg,#2a8fc9,#1d6da0)", skills: ["office"], url: "https://search.bilibili.com/all?keyword=Word%20%E6%96%87%E6%A1%A3%E6%8E%92%E7%89%88%E9%80%9F%E6%88%90" },
  { id: "c-ppt", cat: "职能", icon: "i-layers", title: "PPT 设计与演示实战", sub: "逻辑 / 排版 / 动画 / 演讲", lessons: 20, hours: 8, xp: 18, bg: "linear-gradient(150deg,#d95f33,#b04a26)", skills: ["office", "speaking"], url: "https://search.bilibili.com/all?keyword=PPT%20%E8%AE%BE%E8%AE%A1%E4%B8%8E%E6%BC%94%E7%A4%BA%E5%AE%9E%E6%88%98" },
  { id: "c-acc", cat: "职能", icon: "i-coin", title: "零基础学会计", sub: "考证 / 做账 / 报税全流程", lessons: 40, hours: 20, xp: 35, bg: "linear-gradient(150deg,#2ea56a,#1f8f56)", skills: ["accounting", "office"], url: "https://search.bilibili.com/all?keyword=%E9%9B%B6%E5%9F%BA%E7%A1%80%E5%AD%A6%E4%BC%9A%E8%AE%A1" },
  { id: "c-comm", cat: "职能", icon: "i-chat", title: "职场沟通表达课", sub: "汇报 / 跨部门协作 / 面试表达", lessons: 14, hours: 5, xp: 18, bg: "linear-gradient(150deg,#5ac8fa,#2a8fc9)", skills: ["speaking", "coordinate"], url: "https://search.bilibili.com/all?keyword=%E8%81%8C%E5%9C%BA%E6%B2%9F%E9%80%9A%E8%A1%A8%E8%BE%BE%E8%AF%BE" },
  { id: "c-en", cat: "职能", icon: "i-book", title: "职场英语充电站", sub: "面试口语 / 商务邮件", lessons: 20, hours: 8, xp: 20, bg: "linear-gradient(150deg,#2ea56a,#1f8f56)", skills: ["foreign"], url: "https://search.bilibili.com/all?keyword=%E8%81%8C%E5%9C%BA%E8%8B%B1%E8%AF%AD%E5%85%85%E7%94%B5%E7%AB%99" },
  { id: "c-ai", cat: "互联网", icon: "i-spark", title: "AI 工具生产力课", sub: "提示词 / ChatGPT / 办公自动化", lessons: 18, hours: 6, xp: 22, bg: "linear-gradient(150deg,#2e7dff,#0a58ff)", skills: ["aitool", "office"], url: "https://search.bilibili.com/all?keyword=AI%20%E5%B7%A5%E5%85%B7%E7%94%9F%E4%BA%A7%E5%8A%9B%E8%AF%BE%20ChatGPT" },
  { id: "c-ai2", cat: "互联网", icon: "i-spark", title: "AI 副业变现实战", sub: "AIGC / 接单 / 内容生成", lessons: 20, hours: 8, xp: 24, bg: "linear-gradient(150deg,#0a58ff,#0038b8)", skills: ["aitool", "writing"], url: "https://search.bilibili.com/all?keyword=AI%20%E5%89%AF%E4%B8%9A%E5%8F%98%E7%8E%B0%20AIGC" },
  { id: "c-python", cat: "互联网", icon: "i-code", title: "Python 零基础入门", sub: "小甲鱼全套 · 边学边练", lessons: 90, hours: 40, xp: 40, bg: "linear-gradient(150deg,#17171c,#2b2b33)", skills: ["coding"], url: "https://search.bilibili.com/all?keyword=Python%20%E9%9B%B6%E5%9F%BA%E7%A1%80%E5%85%A5%E9%97%A8%20%E5%B0%8F%E7%94%B2%E9%B1%BC" },
  { id: "c-net", cat: "互联网", icon: "i-code", title: "互联网入行训练营", sub: "产品 / 运营 / 研发通识", lessons: 32, hours: 12, xp: 30, bg: "linear-gradient(150deg,#0a58ff,#0038b8)", skills: ["aitool", "office", "pm"], url: "https://search.bilibili.com/all?keyword=%E4%BA%92%E8%81%94%E7%BD%91%E5%85%A5%E8%A1%8C%E8%AE%AD%E7%BB%83%E8%90%A5" },
  { id: "c-media", cat: "内容", icon: "i-play", title: "短视频创作实战", sub: "脚本 / 拍摄 / 剪辑 / 起号", lessons: 24, hours: 9, xp: 25, bg: "linear-gradient(150deg,#ff6482,#c9345f)", skills: ["photo", "writing"], url: "https://search.bilibili.com/all?keyword=%E7%9F%AD%E8%A7%86%E9%A2%91%E5%88%9B%E4%BD%9C%E5%AE%9E%E6%88%98" },
  { id: "c-clip", cat: "内容", icon: "i-play", title: "剪映零基础速成", sub: "手机剪辑 / 转场 / 字幕 / 特效", lessons: 18, hours: 7, xp: 20, bg: "linear-gradient(150deg,#ff6482,#c9345f)", skills: ["photo"], url: "https://search.bilibili.com/all?keyword=%E5%89%AA%E6%98%A0%20%E9%9B%B6%E5%9F%BA%E7%A1%80%E9%80%9F%E6%88%90" },
  { id: "c-ps", cat: "内容", icon: "i-spark", title: "PS 修图与视觉设计基础", sub: "抠图 / 调色 / 海报排版", lessons: 22, hours: 9, xp: 24, bg: "linear-gradient(150deg,#8e5cf7,#5e3ab8)", skills: ["photo", "uidesign"], url: "https://search.bilibili.com/all?keyword=PS%20%E4%BF%AE%E5%9B%BE%E4%B8%8E%E8%A7%86%E8%A7%89%E8%AE%BE%E8%AE%A1%E5%9F%BA%E7%A1%80" },
  { id: "c-write", cat: "内容", icon: "i-doc", title: "商业文案写作课", sub: "爆款标题 / 转化文案 / 品牌稿", lessons: 16, hours: 6, xp: 18, bg: "linear-gradient(150deg,#c9345f,#a02647)", skills: ["writing", "speaking"], url: "https://search.bilibili.com/all?keyword=%E5%95%86%E4%B8%9A%E6%96%87%E6%A1%88%E5%86%99%E4%BD%9C%E8%AF%BE" },
  { id: "c-ecom", cat: "电商", icon: "i-cart", title: "电商开店全流程", sub: "选品 / 投放 / 转化优化", lessons: 28, hours: 11, xp: 26, bg: "linear-gradient(150deg,#8e5cf7,#6a3bd6)", skills: ["datatool", "photo", "sales"], url: "https://search.bilibili.com/all?keyword=%E7%94%B5%E5%95%86%E5%BC%80%E5%BA%97%E5%85%A8%E6%B5%81%E7%A8%8B" },
  { id: "c-momshop", cat: "电商", icon: "i-cart", title: "宝妈轻创业指南", sub: "选品 / 社群团购 / 时间管理", lessons: 20, hours: 7, xp: 22, bg: "linear-gradient(150deg,#ff9f0a,#c47b00)", skills: ["sales", "writing"], url: "https://search.bilibili.com/all?keyword=%E5%AE%9D%E5%A6%88%E8%BD%BB%E5%88%9B%E4%B8%9A%E6%8C%87%E5%8D%97" },
  { id: "c-cb", cat: "电商", icon: "i-book", title: "跨境电商英语", sub: "选品术语 / 客服邮件 / 平台", lessons: 18, hours: 7, xp: 20, bg: "linear-gradient(150deg,#5e5ce6,#3634a3)", skills: ["foreign", "sales"], url: "https://search.bilibili.com/all?keyword=%E8%B7%A8%E5%A2%83%E7%94%B5%E5%95%86%E8%8B%B1%E8%AF%AD" },
  { id: "c-sale", cat: "销售", icon: "i-brief", title: "大客户成交课", sub: "需求挖掘 / 谈判 / 回款", lessons: 20, hours: 8, xp: 22, bg: "linear-gradient(150deg,#d9b45c,#b8942f)", skills: ["sales", "speaking"], url: "https://search.bilibili.com/all?keyword=%E5%A4%A7%E5%AE%A2%E6%88%B7%E6%88%90%E4%BA%A4%E8%AF%BE" },
  { id: "c-nego", cat: "销售", icon: "i-brief", title: "销售谈判与异议处理", sub: "破冰 / 逼单 / 价格博弈", lessons: 16, hours: 6, xp: 18, bg: "linear-gradient(150deg,#d9b45c,#b8942f)", skills: ["sales", "speaking"], url: "https://search.bilibili.com/all?keyword=%E9%94%80%E5%94%AE%E8%B0%88%E5%88%A4%E4%B8%8E%E5%BC%82%E8%AE%AE%E5%A4%84%E7%90%86" },
  { id: "c-heal", cat: "健康", icon: "i-heart", title: "健康管理师备考班", sub: "营养学 / 慢病管理 / 考证", lessons: 40, hours: 20, xp: 35, bg: "linear-gradient(150deg,#2ea56a,#1f8f56)", skills: ["service", "teach"], url: "https://search.bilibili.com/all?keyword=%E5%81%A5%E5%BA%B7%E7%AE%A1%E7%90%86%E5%B8%88%E5%A4%87%E8%80%83%E7%8F%AD" },
  { id: "c-psych", cat: "健康", icon: "i-heart", title: "心理咨询入门", sub: "倾听技巧 / 基础理论 / 伦理", lessons: 24, hours: 10, xp: 24, bg: "linear-gradient(150deg,#64d2ff,#2a9dc9)", skills: ["teach", "speaking"], url: "https://search.bilibili.com/all?keyword=%E5%BF%83%E7%90%86%E5%92%A8%E8%AF%A2%E5%85%A5%E9%97%A8" },
  { id: "c-nutri", cat: "健康", icon: "i-leaf", title: "营养与体重管理", sub: "膳食搭配 / 慢病饮食 / 配餐", lessons: 20, hours: 8, xp: 20, bg: "linear-gradient(150deg,#4d9c33,#3a7a26)", skills: ["service", "teach"], url: "https://search.bilibili.com/all?keyword=%E8%90%A5%E5%85%BB%E4%B8%8E%E4%BD%93%E9%87%8D%E7%AE%A1%E7%90%86" },
  { id: "c-mgmt", cat: "管理", icon: "i-layers", title: "项目管理 PMP 精讲", sub: "进度 / 风险 / 干系人管理", lessons: 30, hours: 15, xp: 30, bg: "linear-gradient(150deg,#d97a16,#b05f0e)", skills: ["pm", "coordinate"], url: "https://search.bilibili.com/all?keyword=%E9%A1%B9%E7%9B%AE%E7%AE%A1%E7%90%86%20PMP%20%E7%B2%BE%E8%AE%B2" },
  { id: "c-cons", cat: "咨询", icon: "i-bulb", title: "结构化思维训练", sub: "问题拆解 / 方案汇报", lessons: 20, hours: 9, xp: 25, bg: "linear-gradient(150deg,#3a3a42,#26262d)", skills: ["speaking", "writing", "office"], url: "https://search.bilibili.com/all?keyword=%E7%BB%93%E6%9E%84%E5%8C%96%E6%80%9D%E7%BB%B4%E8%AE%AD%E7%BB%83" },
  { id: "c-pm2", cat: "互联网", icon: "i-compass", title: "从零做产品经理", sub: "需求分析 / 原型 / 文档", lessons: 28, hours: 12, xp: 28, bg: "linear-gradient(150deg,#0a58ff,#0038b8)", skills: ["pm", "aitool", "office"], url: "https://search.bilibili.com/all?keyword=%E4%BB%8E%E9%9B%B6%E5%81%9A%E4%BA%A7%E5%93%81%E7%BB%8F%E7%90%86" },
  { id: "c-flex", cat: "灵活就业", icon: "i-car", title: "灵活就业安全指南", sub: "平台规则 / 权益保障", lessons: 10, hours: 3, xp: 12, bg: "linear-gradient(150deg,#2a8fc9,#1d6da0)", skills: ["drive", "service"], url: "https://search.bilibili.com/all?keyword=%E7%81%B5%E6%B4%BB%E5%B0%B1%E4%B8%9A%E5%AE%89%E5%85%A8%E6%8C%87%E5%8D%97" },
  { id: "c-rideshare", cat: "灵活就业", icon: "i-car", title: "网约车合规上岗课", sub: "平台规则 / 接单技巧 / 安全", lessons: 10, hours: 3, xp: 12, bg: "linear-gradient(150deg,#2a8fc9,#1d6da0)", skills: ["drive", "service"], url: "https://search.bilibili.com/all?keyword=%E7%BD%91%E7%BA%A6%E8%BD%A6%E5%90%88%E8%A7%84%E4%B8%8A%E5%B2%97%E8%AF%BE" },
];
