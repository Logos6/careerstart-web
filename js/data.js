...
var INTERESTS = [
  ...
  { id: "legal",    label: "法律与合规", icon: "i-scale" },
  { id: "health",   label: "医疗与健康", icon: "i-pulse" },
  { id: "art",      label: "艺术与文创", icon: "i-palette" },
  { id: "edu",      label: "培训与知识", icon: "i-grad" },
  { id: "logistics",label: "物流与供应链", icon: "i-truck" },
  { id: "realestate",label: "房产与物业", icon: "i-home" },
  { id: "hospitality",label: "餐饮与酒店", icon: "i-cup" },
  { id: "media2",   label: "影视与演艺", icon: "i-film" },
  { id: "agri",     label: "农业与畜牧", icon: "i-seedling" },
  { id: "energy",   label: "能源与环保", icon: "i-flash" },
  { id: "admin",    label: "行政与文秘", icon: "i-doc" },
  { id: "security", label: "安防与消防", icon: "i-shield" },
];
...
var SKILL_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "video",      label: "视频制作" },
      { id: "animation",  label: "动画与特效" },
      { id: "copywriting",label: "广告文案" },
      { id: "branding",   label: "品牌策划" },
      { id: "translate",  label: "翻译与本地化" },
    ],
  },
  {
    group: "人际与实践",
  ...
  },
  {
    ...
    items: [
      ...
      { id: "cook",       label: "烹饪烘焙" },
      { id: "beauty",     label: "美容美发" },
      { id: "childcare",  label: "育儿早教" },
      { id: "elder",      label: "养老照护" },
      { id: "pet",        label: "宠物护理" },
      { id: "agri",       label: "农业种植" },
      { id: "eco",        label: "环保绿植" },
...
var PREF_ITEMS = [
  ...
  { id: "nointerest",label: "不看重兴趣匹配，只看薪资" },
  { id: "meaning",   label: "工作要有社会价值感" },
  { id: "lowstress", label: "低压轻松，不卷" },
  { id: "diverse",   label: "工作内容多样化" },
  { id: "learn",     label: "能持续学习新东西" },
  { id: "local",     label: "离家近，通勤短" },
  { id: "bigco",     label: "大公司 / 体制内" },
  { id: "smallco",   label: "小团队 / 初创公司" },
];
