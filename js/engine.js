...
(function (root, factory) {
  ...
  const INTERVIEW_DB = {
    ...
    // ══════ 24. 电商与新零售 ══════
    ecommerce_retail: [
      { id: 'er1', cat: '选品策略', q: '你怎么决定卖什么产品？你用什么方法来选品？能举一个你选品成功的案例吗？', tips: '展现数据驱动的选品思维', w: 25 },
      { id: 'er2', cat: '流量运营', q: '你怎么获取电商平台的免费流量？你做过付费推广吗？ROI最高的渠道是什么？', tips: '展现流量运营能力', w: 25 },
      { id: 'er3', cat: '转化优化', q: '店铺的转化率从3%提升到8%，你会从哪些方面优化？请给出具体方案。', tips: '展现转化率优化能力', w: 25 },
      { id: 'er4', cat: '直播带货', q: '你有直播带货的经验吗？你怎么设计一场直播的节奏？能分享一个你做得好的案例吗？', tips: '展现直播运营能力', w: 20 },
      { id: 'er5', cat: '私域电商', q: '你怎么通过私域（微信、社群）来提升复购率？你搭建过私域体系吗？', tips: '展现私域运营能力', w: 20 },
      { id: 'er6', cat: '供应链管理', q: '你怎么管理电商的供应链？遇到过断货或库存积压的情况吗？你是怎么处理的？', tips: '展现供应链管理能力', w: 25 },
      { id: 'er7', cat: '用户评价', q: '遇到差评你会怎么处理？你有什么方法来提升好评率？', tips: '展现危机处理和服务意识', w: 20 },
      { id: 'er8', cat: '平台规则', q: '你熟悉哪些电商平台的规则？有没有因为不了解规则而踩过坑？', tips: '展现平台规则了解', w: 20 },
      { id: 'er9', cat: '数据分析', q: '你怎么分析店铺的数据？你最关注哪些指标？能举一个你通过数据发现问题的例子吗？', tips: '展现数据驱动能力', w: 20 },
      { id: 'er10', cat: '品牌建设', q: '你觉得电商做品牌和做白牌有什么区别？你有什么品牌化的策略？', tips: '展现品牌思维', w: 20 },
      { id: 'er11', cat: '客服管理', q: '你怎么管理电商客服团队？你怎么保证客服质量和响应速度？', tips: '展现客服管理能力', w: 20 },
      { id: 'er12', cat: '退货处理', q: '退货率突然升高，你会怎么排查原因？你怎么降低退货率？', tips: '展现问题分析能力', w: 20 },
      { id: 'er13', cat: '跨境电商', q: '你有跨境电商的经验吗？你觉得做国内电商和跨境电商最大的区别是什么？', tips: '展现跨境电商视野', w: 15 },
      { id: 'er14', cat: '内容电商', q: '你怎么理解"内容电商"？你觉得内容和货架电商的核心区别是什么？', tips: '展现内容电商思维', w: 15 },
      { id: 'er15', cat: '新零售', q: '你怎么看待线上线下的融合？你有新零售的实操经验吗？', tips: '展现新零售理解', w: 15 },
    ],

    // ══════ 25. 新能源与环保 ══════
    new_energy: [
      { id: 'ne1', cat: '行业认知', q: '你怎么看待当前新能源行业的发展阶段？你觉得未来3年最大的机会在哪里？', tips: '展现行业洞察力', w: 25 },
      { id: 'ne2', cat: '技术理解', q: '你能用简单的语言解释一下光伏发电/储能/充电桩的工作原理吗？', tips: '展现技术理解能力', w: 20 },
      { id: 'ne3', cat: '政策解读', q: '新能源行业受政策影响很大，你怎么跟踪和解读政策变化？能举一个你因为政策变化而调整策略的例子吗？', tips: '展现政策敏感度', w: 25 },
      { id: 'ne4', cat: '项目管理', q: '你管理过新能源项目吗？新能源项目和传统项目有什么不同的挑战？', tips: '展现项目管理能力', w: 25 },
      { id: 'ne5', cat: '成本控制', q: '新能源项目的成本结构是什么样的？你做过哪些降本增效的工作？', tips: '展现成本意识', w: 20 },
      { id: 'ne6', cat: '碳中和', q: '你怎么理解碳中和？你觉得企业应该怎么应对碳中和趋势？', tips: '展现碳中和认知', w: 20 },
      { id: 'ne7', cat: '安全合规', q: '新能源项目有哪些特殊的安全要求？你怎么确保项目合规？', tips: '展现安全合规意识', w: 20 },
      { id: 'ne8', cat: '市场拓展', q: '你怎么开拓新能源市场？你有什么获客方法？', tips: '展现市场开拓能力', w: 20 },
      { id: 'ne9', cat: '技术创新', q: '你关注哪些新能源技术的新突破？你觉得哪个技术方向最有前景？', tips: '展现技术视野', w: 15 },
      { id: 'ne10', cat: '环保意识', q: '你觉得环保和商业利益之间怎么平衡？你有在工作中推动环保实践的经历吗？', tips: '展现环保意识', w: 15 },
      { id: 'ne11', cat: '供应链', q: '新能源行业的供应链有什么特点？你怎么管理上游供应商？', tips: '展现供应链管理能力', w: 20 },
      { id: 'ne12', cat: '售后服务', q: '新能源设备的售后服务和传统设备有什么不同？你怎么建立售后体系？', tips: '展现服务体系建设能力', w: 20 },
      { id: 'ne13', cat: '投资分析', q: '你怎么评估一个新能源项目的投资回报？你需要考虑哪些因素？', tips: '展现投资分析能力', w: 20 },
      { id: 'ne14', cat: '竞品分析', q: '你研究过新能源领域的竞品吗？竞品做得最好的是什么？你从中学到了什么？', tips: '展现竞争意识', w: 15 },
      { id: 'ne15', cat: '行业趋势', q: '你觉得新能源行业未来5年会发生什么重大变化？你准备好了吗？', tips: '展现行业前瞻性', w: 15 },
    ],

    // ══════ 26. 人工智能与前沿科技 ══════
    ai_tech: [
      { id: 'at1', cat: 'AI应用', q: '你用过哪些AI工具？能举一个你把AI应用到实际工作中的例子吗？', tips: '展现AI应用能力', w: 25 },
      { id: 'at2', cat: '大模型理解', q: '你能简单解释一下大语言模型的工作原理吗？你觉得大模型在哪些场景最有价值？', tips: '展现技术理解力', w: 25 },
      { id: 'at3', cat: 'Prompt工程', q: '你怎么写好一个Prompt？你有什么Prompt优化的技巧？', tips: '展现Prompt工程能力', w: 20 },
      { id: 'at4', cat: '数据标注', q: '你了解数据标注的工作流程吗？你怎么保证标注数据的质量？', tips: '展现数据处理能力', w: 20 },
      { id: 'at5', cat: '模型评估', q: '你怎么评估一个AI模型的效果？你用过哪些评估指标？', tips: '展现模型评估能力', w: 25 },
      { id: 'at6', cat: 'AI伦理', q: '你怎么看待AI的伦理问题？你在工作中遇到过AI伦理相关的挑战吗？', tips: '展现AI伦理意识', w: 20 },
      { id: 'at7', cat: '落地经验', q: '你把AI技术落地到产品中遇到过什么困难？你是怎么解决的？', tips: '展现AI落地能力', w: 25 },
      { id: 'at8', cat: '技术选型', q: '你怎么选择合适的AI技术方案？你需要考虑哪些因素？', tips: '展现技术判断力', w: 20 },
      { id: 'at9', cat: '成本控制', q: 'AI推理成本很高，你怎么优化成本？你做过哪些成本优化的工作？', tips: '展现成本意识', w: 20 },
      { id: 'at10', cat: '行业应用', q: '你觉得AI在你所在行业最有价值的应用场景是什么？', tips: '展现行业理解', w: 20 },
      { id: 'at11', cat: '竞品分析', q: '你怎么跟踪AI领域的最新进展？你关注哪些AI公司或产品？', tips: '展现技术视野', w: 15 },
      { id: 'at12', cat: '团队协作', q: 'AI项目通常需要多角色协作，你怎么和产品经理、工程师配合？', tips: '展现协作能力', w: 20 },
      { id: 'at13', cat: '风险意识', q: '你觉得AI应用最大的风险是什么？你怎么规避这些风险？', tips: '展现风险意识', w: 20 },
      { id: 'at14', cat: '学习路径', q: '你怎么持续学习AI知识？你最近学了什么新的AI技术？', tips: '展现学习能力', w: 15 },
      { id: 'at15', cat: '未来展望', q: '你觉得未来3年AI会怎么改变你的工作？你准备好了吗？', tips: '展现前瞻性思维', w: 15 },
    ],

    // ══════ 27. 银行与保险 ══════
    banking_insurance: [
      { id: 'bi1', cat: '风控经验', q: '你怎么评估一个客户的风险？你用过哪些风控模型或工具？', tips: '展现风控能力', w: 25 },
      { id: 'bi2', cat: '合规管理', q: '银行/保险行业有哪些特殊的合规要求？你怎么确保业务合规？', tips: '展现合规意识', w: 25 },
      { id: 'bi3', cat: '客户管理', q: '你怎么管理高净值客户？你有什么客户分层策略？', tips: '展现客户管理能力', w: 20 },
      { id: 'bi4', cat: '产品销售', q: '你怎么向客户推荐金融产品？你有什么销售技巧？', tips: '展现销售能力', w: 20 },
      { id: 'bi5', cat: '数字化转型', q: '你觉得银行/保险行业的数字化转型最大的挑战是什么？你参与过哪些数字化项目？', tips: '展现数字化视野', w: 25 },
      { id: 'bi6', cat: '数据分析', q: '你怎么用数据来支持业务决策？你做过哪些数据分析项目？', tips: '展现数据分析能力', w: 20 },
      { id: 'bi7', cat: '风险识别', q: '你怎么识别潜在的金融风险？能举一个你成功规避风险的例子吗？', tips: '展现风险识别能力', w: 25 },
      { id: 'bi8', cat: '客户服务', q: '金融行业的客户服务有什么特殊要求？你怎么提升客户满意度？', tips: '展现服务能力', w: 20 },
      { id: 'bi9', cat: '产品创新', q: '你有没有参与过金融产品的设计或创新？你是怎么做的？', tips: '展现创新能力', w: 20 },
      { id: 'bi10', cat: '监管政策', q: '你怎么跟踪和解读金融监管政策？能举一个你因为政策变化而调整业务的例子吗？', tips: '展现政策敏感度', w: 20 },
      { id: 'bi11', cat: '团队管理', q: '你怎么管理金融团队？你怎么保证团队的合规意识？', tips: '展现管理能力', w: 20 },
      { id: 'bi12', cat: '反洗钱', q: '你了解反洗钱的工作流程吗？你做过哪些反洗钱相关的工作？', tips: '展现合规专业度', w: 20 },
      { id: 'bi13', cat: '客户信任', q: '金融行业客户信任很重要，你怎么建立和维护客户信任？', tips: '展现信任建设能力', w: 15 },
      { id: 'bi14', cat: '金融科技', q: '你关注哪些金融科技的新趋势？你觉得哪个技术会改变金融行业？', tips: '展现金融科技视野', w: 15 },
      { id: 'bi15', cat: '职业发展', q: '你觉得金融行业未来5年最大的变化是什么？你准备好了吗？', tips: '展现行业前瞻性', w: 15 },
    ],

    // ══════ 28. 物流与供应链 ══════
    logistics: [
      { id: 'lg1', cat: '供应链优化', q: '你怎么优化供应链流程？你做过哪些降本增效的工作？', tips: '展现供应链优化能力', w: 25 },
      { id: 'lg2', cat: '库存管理', q: '你怎么管理库存？遇到过库存积压或断货的情况吗？你是怎么处理的？', tips: '展现库存管理能力', w: 25 },
      { id: 'lg3', cat: '运输管理', q: '你怎么管理运输成本和时效？你有什么运输优化的方案？', tips: '展现运输管理能力', w: 20 },
      { id: 'lg4', cat: '仓储管理', q: '你怎么管理仓库的日常运营？你用过哪些仓储管理系统？', tips: '展现仓储管理能力', w: 20 },
      { id: 'lg5', cat: '供应商管理', q: '你怎么选择和管理供应商？你有什么供应商评估标准？', tips: '展现供应商管理能力', w: 20 },
      { id: 'lg6', cat: '数据分析', q: '你怎么用数据来优化物流运营？你最关注哪些物流指标？', tips: '展现数据分析能力', w: 20 },
      { id: 'lg7', cat: '应急处理', q: '物流过程中遇到突发情况（如天气、交通），你怎么处理？', tips: '展现应急处理能力', w: 20 },
      { id: 'lg8', cat: '成本控制', q: '你怎么控制物流成本？你做过最成功的成本优化是什么？', tips: '展现成本控制能力', w: 25 },
      { id: 'lg9', cat: '客户满意度', q: '你怎么保证物流服务的客户满意度？你有什么提升服务质量的方法？', tips: '展现服务意识', w: 20 },
      { id: 'lg10', cat: '数字化', q: '你觉得物流行业数字化最大的挑战是什么？你参与过哪些数字化项目？', tips: '展现数字化视野', w: 20 },
      { id: 'lg11', cat: '跨境物流', q: '你有跨境物流的经验吗？跨境物流和国内物流有什么不同的挑战？', tips: '展现跨境物流能力', w: 15 },
      { id: 'lg12', cat: '团队管理', q: '你怎么管理物流团队？你怎么保证团队的执行力？', tips: '展现管理能力', w: 20 },
      { id: 'lg13', cat: '安全管理', q: '物流安全管理有哪些要点？你怎么确保货物安全？', tips: '展现安全意识', w: 15 },
      { id: 'lg14', cat: '绿色物流', q: '你怎么看待绿色物流？你做过哪些环保相关的工作？', tips: '展现环保意识', w: 15 },
      { id: 'lg15', cat: '行业趋势', q: '你觉得物流行业未来5年会发生什么重大变化？你准备好了吗？', tips: '展现行业前瞻性', w: 15 },
    ],

    // ══════ 29. 医药与医疗器械 ══════
    pharma_med: [
      { id: 'pm1', cat: '合规意识', q: '医药行业有哪些特殊的合规要求？你怎么确保工作合规？', tips: '展现合规专业度', w: 25 },
      { id: 'pm2', cat: '产品知识', q: '你怎么学习和掌握医药产品知识？你有什么方法来保持专业知识更新？', tips: '展现学习能力', w: 20 },
      { id: 'pm3', cat: '客户拜访', q: '你怎么和医生/医院建立关系？你有什么客户拜访的技巧？', tips: '展现客户关系能力', w: 25 },
      { id: 'pm4', cat: '学术推广', q: '你怎么做医药产品的学术推广？你觉得学术推广和普通销售有什么区别？', tips: '展现学术推广能力', w: 25 },
      { id: 'pm5', cat: '市场分析', q: '你怎么分析医药市场？你用什么方法来了解市场趋势？', tips: '展现市场分析能力', w: 20 },
      { id: 'pm6', cat: '招标采购', q: '你参与过医院招标采购吗？你怎么准备投标材料？', tips: '展现招标经验', w: 20 },
      { id: 'pm7', cat: '临床试验', q: '你有临床试验的经验吗？你觉得临床试验最大的挑战是什么？', tips: '展现临床试验了解', w: 20 },
      { id: 'pm8', cat: '药品注册', q: '你了解药品注册的流程吗？你需要准备哪些材料？', tips: '展现注册专业度', w: 20 },
      { id: 'pm9', cat: 'GSP/GMP', q: '你了解GSP/GMP规范吗？你在工作中是怎么执行的？', tips: '展现质量管理能力', w: 20 },
      { id: 'pm10', cat: '不良反应', q: '你遇到过药品不良反应的情况吗？你是怎么处理的？', tips: '展现风险管理能力', w: 25 },
      { id: 'pm11', cat: '团队协作', q: '医药销售需要和医学部、市场部协作，你怎么做好跨部门协作？', tips: '展现协作能力', w: 20 },
      { id: 'pm12', cat: '数据分析', q: '你怎么用数据来支持医药销售决策？你关注哪些指标？', tips: '展现数据驱动能力', w: 20 },
      { id: 'pm13', cat: '行业政策', q: '你怎么跟踪医药行业政策变化？能举一个你因为政策变化而调整策略的例子吗？', tips: '展现政策敏感度', w: 20 },
      { id: 'pm14', cat: '创新药', q: '你怎么看待创新药和仿制药的区别？你觉得创新药的市场机会在哪里？', tips: '展现行业理解', w: 15 },
      { id: 'pm15', cat: '职业发展', q: '你觉得医药行业未来5年最大的变化是什么？你准备好了吗？', tips: '展现行业前瞻性', w: 15 },
    ],

    // ══════ 30. 文化与传媒 ══════
    culture_media: [
      { id: 'cm1', cat: '内容创作', q: '你创作过最成功的内容是什么？为什么它能火？请从选题、标题、结构等维度复盘。', tips: '展现内容创作能力', w: 25 },
      { id: 'cm2', cat: '用户洞察', q: '你怎么了解你的受众？你用什么方法来洞察用户需求？', tips: '展现用户洞察能力', w: 20 },
      { id: 'cm3', cat: '平台运营', q: '你运营过哪些内容平台？你觉得不同平台的运营策略有什么区别？', tips: '展现平台运营能力', w: 20 },
      { id: 'cm4', cat: '爆款方法论', q: '你觉得爆款内容有什么共同特点？你有可复制的爆款方法论吗？', tips: '展现内容方法论', w: 25 },
      { id: 'cm5', cat: 'IP打造', q: '你有打造过个人IP或品牌IP吗？你是怎么做的？', tips: '展现IP打造能力', w: 20 },
      { id: 'cm6', cat: '变现策略', q: '你怎么把内容流量变现？你用过哪些变现方式？', tips: '展现商业思维', w: 20 },
      { id: 'cm7', cat: '版权保护', q: '你怎么保护原创内容的版权？你遇到过侵权的情况吗？', tips: '展现版权意识', w: 20 },
      { id: 'cm8', cat: '数据分析', q: '你怎么分析内容数据？你最关注哪些指标？', tips: '展现数据分析能力', w: 20 },
      { id: 'cm9', cat: '热点追踪', q: '你怎么追踪热点？你有快速产出热点内容的经验吗？', tips: '展现热点敏感度', w: 20 },
      { id: 'cm10', cat: '品牌合作', q: '你怎么和品牌方合作？你有什么商务谈判的技巧？', tips: '展现商务能力', w: 20 },
      { id: 'cm11', cat: '视频制作', q: '你有视频制作的经验吗？你觉得短视频和长视频的核心区别是什么？', tips: '展现视频制作能力', w: 20 },
      { id: 'cm12', cat: '社群运营', q: '你怎么运营粉丝社群？你怎么提高社群的活跃度和粘性？', tips: '展现社群运营能力', w: 20 },
      { id: 'cm13', cat: '危机公关', q: '如果发布的内容引发负面舆论，你会怎么处理？', tips: '展现危机处理能力', w: 20 },
      { id: 'cm14', cat: 'AI创作', q: '你怎么看待AI在内容创作中的应用？你用AI辅助创作过吗？', tips: '展现AI应用意识', w: 15 },
      { id: 'cm15', cat: '行业趋势', q: '你觉得内容行业未来3年会发生什么变化？你准备好了吗？', tips: '展现行业前瞻性', w: 15 },
    ],

    // ══════ 31. 建筑与房地产 ══════
    construction_re: [
      { id: 'cr1', cat: '项目管理', q: '你管理过建筑/地产项目吗？你怎么确保项目按时按质交付？', tips: '展现项目管理能力', w: 25 },
      { id: 'cr2', cat: '成本控制', q: '你怎么控制建筑项目的成本？你做过哪些降本增效的工作？', tips: '展现成本控制能力', w: 25 },
      { id: 'cr3', cat: '质量管控', q: '你怎么确保工程质量？你用什么方法来检查和验收？', tips: '展现质量管理能力', w: 20 },
      { id: 'cr4', cat: '安全管理', q: '建筑工地安全管理有哪些要点？你怎么确保施工安全？', tips: '展现安全管理能力', w: 25 },
      { id: 'cr5', cat: '合规经验', q: '建筑行业有哪些特殊的资质和合规要求？你怎么确保项目合规？', tips: '展现合规意识', w: 20 },
      { id: 'cr6', cat: '设计协调', q: '你怎么和设计院协调？遇到设计变更你怎么处理？', tips: '展现协调能力', w: 20 },
      { id: 'cr7', cat: '供应商管理', q: '你怎么管理建材供应商？你怎么控制采购成本？', tips: '展现采购管理能力', w: 20 },
      { id: 'cr8', cat: '销售能力', q: '你有房地产销售的经验吗？你怎么促成客户成交？', tips: '展现销售能力', w: 20 },
      { id: 'cr9', cat: '市场分析', q: '你怎么分析房地产市场？你用什么方法来判断市场趋势？', tips: '展现市场分析能力', w: 20 },
      { id: 'cr10', cat: '客户关系', q: '你怎么维护和客户的关系？你怎么处理客户投诉？', tips: '展现客户关系能力', w: 20 },
      { id: 'cr11', cat: '绿色建筑', q: '你怎么看待绿色建筑？你有参与过绿色建筑项目吗？', tips: '展现环保意识', w: 15 },
      { id: 'cr12', cat: '数字化', q: '你觉得建筑行业数字化最大的挑战是什么？你参与过哪些数字化项目？', tips: '展现数字化视野', w: 15 },
      { id: 'cr13', cat: '团队管理', q: '你怎么管理项目团队？你怎么保证团队的执行力？', tips: '展现管理能力', w: 20 },
      { id: 'cr14', cat: '风险管控', q: '你怎么识别和管控项目风险？能举一个你成功规避风险的例子吗？', tips: '展现风险管控能力', w: 20 },
      { id: 'cr15', cat: '行业趋势', q: '你觉得建筑/房地产行业未来5年会发生什么重大变化？你准备好了吗？', tips: '展现行业前瞻性', w: 15 },
    ],

    // ══════ 32. 餐饮与酒店管理 ══════
    hospitality: [
      { id: 'ht1', cat: '服务标准', q: '你怎么建立和执行服务标准？你觉得好的服务最重要的3个要素是什么？', tips: '展现服务体系建设能力', w: 25 },
      { id: 'ht2', cat: '客户体验', q: '你怎么提升客户体验？你能举一个你通过改善体验提升业绩的例子吗？', tips: '展现客户体验思维', w: 25 },
      { id: 'ht3', cat: '运营管理', q: '你怎么管理餐饮/酒店的日常运营？你用什么方法来提升运营效率？', tips: '展现运营管理能力', w: 20 },
      { id: 'ht4', cat: '成本控制', q: '你怎么控制食材/运营成本？你做过最成功的成本优化是什么？', tips: '展现成本控制能力', w: 25 },
      { id: 'ht5', cat: '团队培训', q: '你怎么培训服务人员？你有一套自己的培训方法吗？', tips: '展现培训能力', w: 20 },
      { id: 'ht6', cat: '食品安全', q: '你怎么确保食品安全？你遇到过食品安全问题吗？你是怎么处理的？', tips: '展现食品安全意识', w: 25 },
      { id: 'ht7', cat: '营销推广', q: '你怎么做餐饮/酒店的营销？你用过哪些推广渠道？效果怎么样？', tips: '展现营销能力', w: 20 },
      { id: 'ht8', cat: '投诉处理', q: '遇到客户投诉，你怎么处理？能举一个你处理过的最棘手的案例吗？', tips: '展现投诉处理能力', w: 20 },
      { id: 'ht9', cat: 'OTA运营', q: '你怎么管理美团、大众点评等OTA平台？你怎么提升排名和评分？', tips: '展现OTA运营能力', w: 20 },
      { id: 'ht10', cat: '数据分析', q: '你怎么用数据来优化餐饮/酒店运营？你关注哪些指标？', tips: '展现数据驱动能力', w: 20 },
      { id: 'ht11', cat: '供应链管理', q: '你怎么管理食材供应商？你怎么保证食材质量和供应稳定？', tips: '展现供应链管理能力', w: 20 },
      { id: 'ht12', cat: '品牌建设', q: '你怎么打造餐饮/酒店品牌？你觉得品牌最重要的3个要素是什么？', tips: '展现品牌思维', w: 20 },
      { id: 'ht13', cat: '员工管理', q: '餐饮/酒店行业人员流动大，你怎么留住员工？', tips: '展现员工管理能力', w: 20 },
      { id: 'ht14', cat: '创新意识', q: '你有没有做过餐饮/酒店的创新项目？效果怎么样？', tips: '展现创新能力', w: 15 },
      { id: 'ht15', cat: '行业趋势', q: '你觉得餐饮/酒店行业未来3年会发生什么变化？你准备好了吗？', tips: '展现行业前瞻性', w: 15 },
    ],

    // ══════ 33. 农业与畜牧 ══════
    agriculture: [
      { id: 'ag1', cat: '种植技术', q: '你了解哪些种植技术？你有实际的种植经验吗？', tips: '展现农业技术能力', w: 20 },
      { id: 'ag2', cat: '畜牧管理', q: '你怎么管理畜牧养殖？你用什么方法来保证牲畜健康？', tips: '展现畜牧管理能力', w: 20 },
      { id: 'ag3', cat: '农产品销售', q: '你怎么销售农产品？你用过哪些销售渠道？', tips: '展现销售能力', w: 20 },
      { id: 'ag4', cat: '供应链', q: '你怎么管理农产品的供应链？你怎么保证农产品的新鲜度？', tips: '展现供应链管理能力', w: 25 },
      { id: 'ag5', cat: '农业政策', q: '你怎么跟踪和解读农业政策？能举一个你利用政策获得支持的例子吗？', tips: '展现政策敏感度', w: 20 },
      { id: 'ag6', cat: '成本控制', q: '你怎么控制农业生产成本？你做过哪些降本增效的工作？', tips: '展现成本控制能力', w: 20 },
      { id: 'ag7', cat: '质量管控', q: '你怎么保证农产品质量？你做过哪些质量检测工作？', tips: '展现质量管控能力', w: 20 },
      { id: 'ag8', cat: '农业电商', q: '你有通过电商销售农产品的经验吗？你用过哪些平台？', tips: '展现电商能力', w: 20 },
      { id: 'ag9', cat: '智慧农业', q: '你怎么看待智慧农业？你用过哪些农业技术设备？', tips: '展现技术视野', w: 15 },
      { id: 'ag10', cat: '环保合规', q: '农业生产有哪些环保要求？你怎么确保生产环保合规？', tips: '展现环保意识', w: 20 },
      { id: 'ag11', cat: '团队管理', q: '你怎么管理农业团队？你怎么保证团队的执行力？', tips: '展现管理能力', w: 20 },
      { id: 'ag12', cat: '风险管控', q: '农业生产有哪些主要风险？你怎么管控这些风险？', tips: '展现风险管控能力', w: 20 },
      { id: 'ag13', cat: '品牌打造', q: '你怎么打造农产品品牌？你觉得农产品品牌最重要的是什么？', tips: '展现品牌思维', w: 15 },
      { id: 'ag14', cat: '合作社', q: '你了解农业合作社的运营模式吗？你有参与过合作社吗？', tips: '展现组织能力', w: 15 },
      { id: 'ag15', cat: '行业趋势', q: '你觉得农业未来5年会发生什么重大变化？你准备好了吗？', tips: '展现行业前瞻性', w: 15 },
    ],
