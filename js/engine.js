...
(function (root, factory) {
  ...
  const INTERVIEW_DB = {
    ...
    career_gap: [
      ...
      { id: 'cg15', cat: '自我怀疑', q: '你有没有怀疑过自己重返职场的决定？是什么让你坚持下来的？', tips: '真实+展现韧性', w: 15 },
    ],
    ...
    career_change: [
      ...
      { id: 'cc7', cat: '年龄顾虑', q: '你觉得年龄对转行有影响吗？你怎么应对年龄带来的偏见？', tips: '展现积极心态', w: 20 },
    ...
    pressure: [
      ...
      { id: 'p4', cat: '焦虑管理', q: '你怎么管理工作焦虑？你有什么减压方法？', tips: '展现情绪管理能力', w: 20 },
      ...
      { id: 'p8', cat: 'burnout', q: '你有没有经历过职业倦怠？你是怎么发现的？你是怎么走出来的？', tips: '展现自我觉察能力', w: 20 },
      ...
      { id: 'p13', cat: '失败恐惧', q: '你害怕失败吗？你怎么处理对失败的恐惧？', tips: '展现面对恐惧的勇气', w: 15 },
      { id: 'p14', cat: '完美主义', q: '你是一个完美主义者吗？你觉得完美主义在工作中是优势还是劣势？', tips: '展现自我认知', w: 15 },
      { id: 'p15', cat: '压力释放', q: '你下班后怎么释放压力？你觉得什么活动对你最有效？', tips: '展现生活方式', w: 15 },
    ],
    ...
    mom_special: [
      ...
      { id: 'ms6', cat: '年龄焦虑', q: '35+重返职场，你有没有年龄焦虑？你怎么应对这种焦虑？', tips: '展现积极心态', w: 20 },
      ...
      { id: 'ms12', cat: '自我怀疑', q: '你有没有怀疑过自己重返职场的决定？是什么让你坚持下来的？', tips: '真实+展现韧性', w: 15 },
      { id: 'ms13', cat: '精力管理', q: '你怎么管理自己的精力？你怎么保证工作时精力充沛？', tips: '展现精力管理能力', w: 15 },
      { id: 'ms14', cat: '社会偏见', q: '你遇到过因为宝妈身份而被区别对待的情况吗？你是怎么应对的？', tips: '展现应对偏见的能力', w: 20 },
